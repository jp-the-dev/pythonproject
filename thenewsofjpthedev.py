...
def thenewsofjpthedev():
    ...
    print("\n")
    print("Die aktuellen Nachrichten - The new news")
    print("\n")
    print("[1] Petya ist jetzt 4 Jahre alt...                      (Deutsch)")
    print("[2] Welche Computerviren sind die gefährlichsten?       (Deutsch)")
